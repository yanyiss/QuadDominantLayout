...
void SurfaceMeshProcessing::createActions()
{
	...
	openAction->setIcon(QIcon("../resource/Images/Open.png"));
	...
	saveAction->setIcon(QIcon("../resource/Images/Save.png"));
	...
	clearAction->setIcon(QIcon("../resource/Images/ClearMesh.png"));
	...
	wireFrameAction->setIcon(QIcon("../resource/Images/wire.png"));
	...
	hiddenLinesAction->setIcon(QIcon("../resource/Images/hiddenlines.png"));
	...
	solidFlatAction->setIcon(QIcon("../resource/Images/flat.png"));
	...
	flatPointsAction->setIcon(QIcon("../resource/Images/flatlines.png"));
	...
	solidSmoothAction->setIcon(QIcon("../resource/Images/smooth.png"));
	...
	pointSetAction->setIcon(QIcon("../resource/Images/points.png"));
	...
	drawBoundingBox->setIcon(QIcon("../resource/Images/bbox.png"));
	...
	drawMeshBoundaryAction->setIcon(QIcon("../resource/Images/boundary.png"));
	...
	updateMeshAction->setIcon(QIcon("../resource/Images/Update.png"));
	...
	PointPickAction->setIcon(QIcon("../resource/Images/selections.png"));
	...
	VertexPickAction->setIcon(QIcon("../resource/Images/selectVertices.png"));
	...
	FacePickAction->setIcon(QIcon("../resource/Images/selectFaces.png"));
	...
	EdgePickAction->setIcon(QIcon("../resource/Images/selectEdges.png"));
	...
	clearSelectedAction->setIcon(QIcon("../resource/Images/clear_select.png"));
	...
	moveVertexAction->setIcon(QIcon("../resource/Images/move_vertex.png"));
	...
	showDebugTestAction->setIcon(QIcon("../resource/Images/move_vertex.png"));
	...
	EditUndoAction->setIcon(QIcon("../resource/Images/edit-undo.png"));
	...
	EditRedoAction->setIcon(QIcon("../resource/Images/edit-redo.png"));
	...
	EdgeCollpaseAction->setIcon(QIcon("../resource/Images/topology-edgeCollapse.png"));
	...
	EdgeSplitAction->setIcon(QIcon("../resource/Images/topology-edgeSplit.png"));
	...
	EdgeFlipAction->setIcon(QIcon("../resource/Images/topology-edgeFlip.png"));
	...
	saveScreenAction->setIcon(QIcon("../resource/Images/saveScreen.png"));
